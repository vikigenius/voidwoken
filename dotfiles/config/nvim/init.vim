...
" Enable blinking cursor: Block during normal ibeam during insert
" Terminals cannot query so we reset to blinking on leave
au VimEnter,VimResume * set guicursor=n-v-c:block,i-ci-ve:ver25,r-cr:hor20,o:hor50
  \,a:blinkwait800-blinkoff450-blinkon350-Cursor/lCursor
  \,sm:block-blinkwait175-blinkoff150-blinkon175

au VimLeave,VimSuspend * set guicursor=a:block-blinkwait800-blinkoff450-blinkon350
